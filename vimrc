...
" Change the highlight style for spellcheck.
hi clear SpellBad
...
" Digraphs for blackboard bold Z and blackboard bold R
digraph $Z 8484
digraph $R 8477

autocmd BufRead *.rs :setlocal tags=./rusty-tags.vi;/

" Store swap files in a tmp directory rather than in the working tree.
